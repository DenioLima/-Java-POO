 ...
 */
package com.mycompany.contador01swing;

/**
 *
 * @author Diego
 */
public class Contador01Swing extends javax.swing.JFrame {

    /**
     * Creates new form Contador01Swing
     */
    public Contador01Swing() {
        initComponents();
    }
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(txtContador, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int quantidade = Integer.parseInt(txtContador.getText());
        int con = 0;
        String contagem = "";
        while (con <= quantidade){
            contagem += con;
            con++;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Contador01Swing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Contador01Swing().setVisible(true);
            }
        });
    }
